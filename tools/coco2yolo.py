...
parser.add_argument('--json_path', default='data/people_det/train/_annotations.coco.json',type=str, help="input: coco format(json)")
parser.add_argument('--save_path', default='data/people_det/train_labels', type=str, help="specify where to save the output dir of labels")
